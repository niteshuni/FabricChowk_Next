...
const MessageTextarea = (props: MessageTextareaProps) => {
    ...
    const onChangeHandler = (e: ChangeEvent<HTMLTextAreaElement>) => {
        props.setItemText(e.target.value);
    };

  return (
    <>
      <label className="mb-[5px] block font-bold w-full text-base text-dark">
        Comment
        ...
        <textarea
          ...
          className="w-full font-medium bg-transparent rounded-md border border-stroke p-3 pl-12 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2"
        />
