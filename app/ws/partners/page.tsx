        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-full text-center">
              ...
              Embark on a journey of textile supremacy with FabricChowk&apos;s Wholesaler Showcase. 
              Explore a tapestry of reliable partners, offering premium fabrics that elevate your business to new heights of success.
              </p>
            </div>
          </div>
        </div>
