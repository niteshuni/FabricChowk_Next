...
const WholeSalerSignIn = () => {
    ...
    const onSignInHandler = () => {
        localStorage.setItem("signedws", "true");
        router.push("/ws");
    };
              ...
              <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
                ...
                <form>
                  <p className="mb-6 text-base text-secondary-color">
                    Hello, Fabric Maestro! <br/>👋 Welcome to FabricChowk, where
                    wholesale fabric sourcing meets convenience. Explore a world
                    of quality textiles tailored for your business. Your success
                    in the fabric industry begins here. Sign in and let the
                    fabric journey unfold! 🌐✨
                  </p>
