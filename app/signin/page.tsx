...
const RetailerSignIn = () => {
    ...
    const onSignInHandler = () => {
        localStorage.setItem("signedrt", "true");
        router.push("/");
    };
            ...
            <div className="w-full px-4">
              <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
                <div className="text-center mb-7">
                  <a href="/ws" className="mx-auto inline-block ">
                    <Image
                ...
                <p className="mb-6 text-base text-secondary-color">
                  Hello, Style Curator! <br/>👋 Welcome to FabricChowk, your
                  gateway to the latest in fabric trends. Elevate your retail
                  offerings with our premium fabric collection. Sign in now and
                  discover the perfect fabrics to enchant your customers. Let&apos;s
                  create fashion stories together! 🌟🧵
                </p>
                <form>
    ...
    const InputBox = ({ type, placeholder, name }: {type: string, placeholder: string, name: string}) => {
      return (
        <div className="mb-6">
          <input
            type={type}
